...
class TestCard(unittest.TestCase):
      def testit(self):
           ...
           cardtwo=Card(1,1)
           cardthree=Card(1) 
           self.assertEqual(cardone.rank,4) 
           self.assertEqual(cardthree.rank,2)
           self.assertEqual(cardtwo.suit,'Clubs') 
           self.assertEqual(cardtwo.rank, 'Ace')  
           self.assertEqual(cardtwo.rank_num,1) 
           self.assertEqual(cardtwo.__str__,"Ace of Clubs")
...
class TestDeck(unittest.TestCase):
       ...
       def testdeck(self):
          cardtest=Card(1)
          tdeck=Deck()
          self.assertEqual(len(tdeck.cards),52)
          self.assertEqual(tdeck.pop_card(),tdeck.cards.pop(-1))
          self.assertEqual(tdeck.replace_card,cardtest.__str__,)
